...
- بعد نجاح الاختبارات الحالية، إضافة **Gradle Managed Device** إن أمكن دون جعل CI هشًا أو معتمدًا على بيئة غير موثوقة.
- بعد نجاح Gradle Managed Device وCI، إعادة الحكم على حالة **Batch 7** دون إعادة تنفيذ العمل السابق بالكامل، مع الاكتفاء بالتحقق الموجّه للفجوات المتبقية.

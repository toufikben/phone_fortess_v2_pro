...
data class SecurityEventEntity(
    ...
    fun toDomain(): SecurityEvent = SecurityEvent(
        id = eventId,
        timestamp = timestamp,
        ...
        threatReasons = threatReasons.split("|||").filter { it.isNotBlank() },
    ...
    companion object {
        fun fromDomain(e: SecurityEvent) = SecurityEventEntity(
            ...
            threatLevel = e.threatLevel.name,
            threatReasons = e.threatReasons.joinToString("|||"),
